...
gate _circuit_207 _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5 {
  h _gate_q_5;
...
gate _circuit_207_dg _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5 {
  h _gate_q_0;
  cp(-pi/2) _gate_q_1, _gate_q_0;
  h _gate_q_1;
  cp(-pi/4) _gate_q_2, _gate_q_0;
...
qubit[6] a;
qubit[6] b;
_circuit_207 b[0], b[1], b[2], b[3], b[4], b[5];
cp(pi) a[0], b[0];
cp(pi/2) a[0], b[1];
cp(pi/4) a[0], b[2];
cp(pi/8) a[0], b[3];
...
cp(pi/2) a[4], b[5];
cp(pi) a[5], b[5];
_circuit_207_dg b[0], b[1], b[2], b[3], b[4], b[5];
