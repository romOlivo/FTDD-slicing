...
gate _circuit_192 _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4 {
  h _gate_q_4;
...
gate _circuit_192_dg _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4 {
  h _gate_q_0;
  cp(-pi/2) _gate_q_1, _gate_q_0;
  h _gate_q_1;
  cp(-pi/4) _gate_q_2, _gate_q_0;
...
qubit[5] a;
qubit[5] b;
_circuit_192 b[0], b[1], b[2], b[3], b[4];
cp(pi) a[0], b[0];
cp(pi/2) a[0], b[1];
cp(pi/4) a[0], b[2];
cp(pi/8) a[0], b[3];
...
cp(pi/2) a[3], b[4];
cp(pi) a[4], b[4];
_circuit_192_dg b[0], b[1], b[2], b[3], b[4];
