...
gate qft_dg _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5, _gate_q_6 {
...
cp(pi/2) $2, $1;
h $1;
cp(-0.177598159698248) $1, $0;
h $1;
cp(-0.355196319396496) $2, $0;
h $2;
cp(-0.710392638792992) $3, $0;
h $3;
cp(-1.420785277585984) $4, $0;
h $4;
cp(-2.841570555171968) $5, $0;
h $5;
cp(-5.683141110343936) $6, $0;
h $6;
cp(-11.366282220687872) $7, $0;
h $7;
c[0] = measure $0;
