...
gate _circuit_235 _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5 {
  h _gate_q_5;
...
gate _circuit_235_dg _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5 {
  h _gate_q_0;
  cp(-pi/2) _gate_q_1, _gate_q_0;
  h _gate_q_1;
  cp(-pi/4) _gate_q_2, _gate_q_0;
...
qubit[3] b;
qubit[6] out;
_circuit_235 out[0], out[1], out[2], out[3], out[4], out[5];
mcphase(16*pi) a[2], b[2], out[0];
mcphase_0(8*pi) a[2], b[2], out[1];
mcphase_1(4*pi) a[2], b[2], out[2];
mcphase_2(2*pi) a[2], b[2], out[3];
mcphase_3(pi) a[2], b[2], out[4];
mcphase_4(pi/2) a[2], b[2], out[5];
mcphase_5(8*pi) a[2], b[1], out[0];
mcphase_6(4*pi) a[2], b[1], out[1];
mcphase_7(2*pi) a[2], b[1], out[2];
mcphase_8(pi) a[2], b[1], out[3];
mcphase_9(pi/2) a[2], b[1], out[4];
mcphase_10(pi/4) a[2], b[1], out[5];
mcphase_11(4*pi) a[2], b[0], out[0];
mcphase_12(8*pi) a[1], b[2], out[0];
mcphase_13(2*pi) a[2], b[0], out[1];
mcphase_14(4*pi) a[1], b[2], out[1];
mcphase_15(pi) a[2], b[0], out[2];
mcphase_16(2*pi) a[1], b[2], out[2];
mcphase_17(pi/2) a[2], b[0], out[3];
mcphase_18(pi) a[1], b[2], out[3];
mcphase_19(pi/4) a[2], b[0], out[4];
mcphase_20(pi/2) a[1], b[2], out[4];
mcphase_21(pi/8) a[2], b[0], out[5];
mcphase_22(pi/4) a[1], b[2], out[5];
mcphase_23(4*pi) a[1], b[1], out[0];
mcphase_24(2*pi) a[1], b[1], out[1];
mcphase_25(pi) a[1], b[1], out[2];
mcphase_26(pi/2) a[1], b[1], out[3];
mcphase_27(pi/4) a[1], b[1], out[4];
mcphase_28(pi/8) a[1], b[1], out[5];
mcphase_29(2*pi) a[1], b[0], out[0];
mcphase_30(4*pi) a[0], b[2], out[0];
mcphase_31(pi) a[1], b[0], out[1];
mcphase_32(2*pi) a[0], b[2], out[1];
mcphase_33(pi/2) a[1], b[0], out[2];
mcphase_34(pi) a[0], b[2], out[2];
mcphase_35(pi/4) a[1], b[0], out[3];
mcphase_36(pi/2) a[0], b[2], out[3];
mcphase_37(pi/8) a[1], b[0], out[4];
mcphase_38(pi/4) a[0], b[2], out[4];
mcphase_39(pi/16) a[1], b[0], out[5];
mcphase_40(pi/8) a[0], b[2], out[5];
mcphase_41(2*pi) a[0], b[1], out[0];
mcphase_42(pi) a[0], b[1], out[1];
mcphase_43(pi/2) a[0], b[1], out[2];
mcphase_44(pi/4) a[0], b[1], out[3];
mcphase_45(pi/8) a[0], b[1], out[4];
mcphase_46(pi/16) a[0], b[1], out[5];
mcphase_47(pi) a[0], b[0], out[0];
mcphase_48(pi/2) a[0], b[0], out[1];
mcphase_49(pi/4) a[0], b[0], out[2];
mcphase_50(pi/8) a[0], b[0], out[3];
mcphase_51(pi/16) a[0], b[0], out[4];
mcphase_52(pi/32) a[0], b[0], out[5];
_circuit_235_dg out[0], out[1], out[2], out[3], out[4], out[5];
...
meas[4] = measure b[1];
meas[5] = measure b[2];
meas[6] = measure out[0];
meas[7] = measure out[1];
meas[8] = measure out[2];
meas[9] = measure out[3];
meas[10] = measure out[4];
meas[11] = measure out[5];
