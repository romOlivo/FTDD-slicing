...
gate _circuit_218 _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3 {
  h _gate_q_3;
...
gate _circuit_218_dg _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3 {
  h _gate_q_0;
  cp(-pi/2) _gate_q_1, _gate_q_0;
  h _gate_q_1;
  cp(-pi/4) _gate_q_2, _gate_q_0;
...
qubit[2] b;
qubit[4] out;
_circuit_218 out[0], out[1], out[2], out[3];
mcphase(4*pi) a[1], b[1], out[0];
mcphase_0(2*pi) a[1], b[1], out[1];
mcphase_1(pi) a[1], b[1], out[2];
mcphase_2(pi/2) a[1], b[1], out[3];
mcphase_3(2*pi) a[1], b[0], out[0];
mcphase_4(2*pi) a[0], b[1], out[0];
mcphase_5(pi) a[1], b[0], out[1];
mcphase_6(pi) a[0], b[1], out[1];
mcphase_7(pi/2) a[1], b[0], out[2];
mcphase_8(pi/2) a[0], b[1], out[2];
mcphase_9(pi/4) a[1], b[0], out[3];
mcphase_10(pi/4) a[0], b[1], out[3];
mcphase_11(pi) a[0], b[0], out[0];
mcphase_12(pi/2) a[0], b[0], out[1];
mcphase_13(pi/4) a[0], b[0], out[2];
mcphase_14(pi/8) a[0], b[0], out[3];
_circuit_218_dg out[0], out[1], out[2], out[3];
barrier a[0], a[1], b[0], b[1], out[0], out[1], out[2], out[3];
meas[0] = measure a[0];
meas[1] = measure a[1];
meas[2] = measure b[0];
meas[3] = measure b[1];
meas[4] = measure out[0];
meas[5] = measure out[1];
meas[6] = measure out[2];
meas[7] = measure out[3];
