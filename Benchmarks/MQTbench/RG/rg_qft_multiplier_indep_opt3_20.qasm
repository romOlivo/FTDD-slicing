...
gate _circuit_456 _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5, _gate_q_6, _gate_q_7, _gate_q_8, _gate_q_9 {
  h _gate_q_9;
...
gate _circuit_456_dg _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5, _gate_q_6, _gate_q_7, _gate_q_8, _gate_q_9 {
  h _gate_q_0;
  cp(-pi/2) _gate_q_1, _gate_q_0;
  h _gate_q_1;
  cp(-pi/4) _gate_q_2, _gate_q_0;
...
qubit[5] b;
qubit[10] out;
_circuit_456 out[0], out[1], out[2], out[3], out[4], out[5], out[6], out[7], out[8], out[9];
mcphase(256*pi) a[4], b[4], out[0];
mcphase_0(128*pi) a[4], b[4], out[1];
mcphase_1(64*pi) a[4], b[4], out[2];
mcphase_2(32*pi) a[4], b[4], out[3];
mcphase_3(16*pi) a[4], b[4], out[4];
mcphase_4(8*pi) a[4], b[4], out[5];
mcphase_5(4*pi) a[4], b[4], out[6];
mcphase_6(2*pi) a[4], b[4], out[7];
mcphase_7(pi) a[4], b[4], out[8];
mcphase_8(pi/2) a[4], b[4], out[9];
mcphase_9(128*pi) a[4], b[3], out[0];
mcphase_10(64*pi) a[4], b[3], out[1];
mcphase_11(32*pi) a[4], b[3], out[2];
mcphase_12(16*pi) a[4], b[3], out[3];
mcphase_13(8*pi) a[4], b[3], out[4];
mcphase_14(4*pi) a[4], b[3], out[5];
mcphase_15(2*pi) a[4], b[3], out[6];
mcphase_16(pi) a[4], b[3], out[7];
mcphase_17(pi/2) a[4], b[3], out[8];
mcphase_18(pi/4) a[4], b[3], out[9];
mcphase_19(64*pi) a[4], b[2], out[0];
mcphase_20(32*pi) a[4], b[2], out[1];
mcphase_21(16*pi) a[4], b[2], out[2];
mcphase_22(8*pi) a[4], b[2], out[3];
mcphase_23(4*pi) a[4], b[2], out[4];
mcphase_24(2*pi) a[4], b[2], out[5];
mcphase_25(pi) a[4], b[2], out[6];
mcphase_26(pi/2) a[4], b[2], out[7];
mcphase_27(pi/4) a[4], b[2], out[8];
mcphase_28(pi/8) a[4], b[2], out[9];
mcphase_29(32*pi) a[4], b[1], out[0];
mcphase_30(16*pi) a[4], b[1], out[1];
mcphase_31(8*pi) a[4], b[1], out[2];
mcphase_32(4*pi) a[4], b[1], out[3];
mcphase_33(2*pi) a[4], b[1], out[4];
mcphase_34(pi) a[4], b[1], out[5];
mcphase_35(pi/2) a[4], b[1], out[6];
mcphase_36(pi/4) a[4], b[1], out[7];
mcphase_37(pi/8) a[4], b[1], out[8];
mcphase_38(pi/16) a[4], b[1], out[9];
mcphase_39(16*pi) a[4], b[0], out[0];
mcphase_40(128*pi) a[3], b[4], out[0];
mcphase_41(8*pi) a[4], b[0], out[1];
mcphase_42(64*pi) a[3], b[4], out[1];
mcphase_43(4*pi) a[4], b[0], out[2];
mcphase_44(32*pi) a[3], b[4], out[2];
mcphase_45(2*pi) a[4], b[0], out[3];
mcphase_46(16*pi) a[3], b[4], out[3];
mcphase_47(pi) a[4], b[0], out[4];
mcphase_48(8*pi) a[3], b[4], out[4];
mcphase_49(pi/2) a[4], b[0], out[5];
mcphase_50(4*pi) a[3], b[4], out[5];
mcphase_51(pi/4) a[4], b[0], out[6];
mcphase_52(2*pi) a[3], b[4], out[6];
mcphase_53(pi/8) a[4], b[0], out[7];
mcphase_54(pi) a[3], b[4], out[7];
mcphase_55(pi/16) a[4], b[0], out[8];
mcphase_56(pi/2) a[3], b[4], out[8];
mcphase_57(pi/32) a[4], b[0], out[9];
mcphase_58(pi/4) a[3], b[4], out[9];
mcphase_59(64*pi) a[3], b[3], out[0];
mcphase_60(32*pi) a[3], b[3], out[1];
mcphase_61(16*pi) a[3], b[3], out[2];
mcphase_62(8*pi) a[3], b[3], out[3];
mcphase_63(4*pi) a[3], b[3], out[4];
mcphase_64(2*pi) a[3], b[3], out[5];
mcphase_65(pi) a[3], b[3], out[6];
mcphase_66(pi/2) a[3], b[3], out[7];
mcphase_67(pi/4) a[3], b[3], out[8];
mcphase_68(pi/8) a[3], b[3], out[9];
mcphase_69(32*pi) a[3], b[2], out[0];
mcphase_70(16*pi) a[3], b[2], out[1];
mcphase_71(8*pi) a[3], b[2], out[2];
mcphase_72(4*pi) a[3], b[2], out[3];
mcphase_73(2*pi) a[3], b[2], out[4];
mcphase_74(pi) a[3], b[2], out[5];
mcphase_75(pi/2) a[3], b[2], out[6];
mcphase_76(pi/4) a[3], b[2], out[7];
mcphase_77(pi/8) a[3], b[2], out[8];
mcphase_78(pi/16) a[3], b[2], out[9];
mcphase_79(16*pi) a[3], b[1], out[0];
mcphase_80(8*pi) a[3], b[1], out[1];
mcphase_81(4*pi) a[3], b[1], out[2];
mcphase_82(2*pi) a[3], b[1], out[3];
mcphase_83(pi) a[3], b[1], out[4];
mcphase_84(pi/2) a[3], b[1], out[5];
mcphase_85(pi/4) a[3], b[1], out[6];
mcphase_86(pi/8) a[3], b[1], out[7];
mcphase_87(pi/16) a[3], b[1], out[8];
mcphase_88(pi/32) a[3], b[1], out[9];
mcphase_89(8*pi) a[3], b[0], out[0];
mcphase_90(64*pi) a[2], b[4], out[0];
mcphase_91(4*pi) a[3], b[0], out[1];
mcphase_92(32*pi) a[2], b[4], out[1];
mcphase_93(2*pi) a[3], b[0], out[2];
mcphase_94(16*pi) a[2], b[4], out[2];
mcphase_95(pi) a[3], b[0], out[3];
mcphase_96(8*pi) a[2], b[4], out[3];
mcphase_97(pi/2) a[3], b[0], out[4];
mcphase_98(4*pi) a[2], b[4], out[4];
mcphase_99(pi/4) a[3], b[0], out[5];
mcphase_100(2*pi) a[2], b[4], out[5];
mcphase_101(pi/8) a[3], b[0], out[6];
mcphase_102(pi) a[2], b[4], out[6];
mcphase_103(pi/16) a[3], b[0], out[7];
mcphase_104(pi/2) a[2], b[4], out[7];
mcphase_105(pi/32) a[3], b[0], out[8];
mcphase_106(pi/4) a[2], b[4], out[8];
mcphase_107(pi/64) a[3], b[0], out[9];
mcphase_108(pi/8) a[2], b[4], out[9];
mcphase_109(32*pi) a[2], b[3], out[0];
mcphase_110(16*pi) a[2], b[3], out[1];
mcphase_111(8*pi) a[2], b[3], out[2];
mcphase_112(4*pi) a[2], b[3], out[3];
mcphase_113(2*pi) a[2], b[3], out[4];
mcphase_114(pi) a[2], b[3], out[5];
mcphase_115(pi/2) a[2], b[3], out[6];
mcphase_116(pi/4) a[2], b[3], out[7];
mcphase_117(pi/8) a[2], b[3], out[8];
mcphase_118(pi/16) a[2], b[3], out[9];
mcphase_119(16*pi) a[2], b[2], out[0];
mcphase_120(8*pi) a[2], b[2], out[1];
mcphase_121(4*pi) a[2], b[2], out[2];
mcphase_122(2*pi) a[2], b[2], out[3];
mcphase_123(pi) a[2], b[2], out[4];
mcphase_124(pi/2) a[2], b[2], out[5];
mcphase_125(pi/4) a[2], b[2], out[6];
mcphase_126(pi/8) a[2], b[2], out[7];
mcphase_127(pi/16) a[2], b[2], out[8];
mcphase_128(pi/32) a[2], b[2], out[9];
mcphase_129(8*pi) a[2], b[1], out[0];
mcphase_130(4*pi) a[2], b[1], out[1];
mcphase_131(2*pi) a[2], b[1], out[2];
mcphase_132(pi) a[2], b[1], out[3];
mcphase_133(pi/2) a[2], b[1], out[4];
mcphase_134(pi/4) a[2], b[1], out[5];
mcphase_135(pi/8) a[2], b[1], out[6];
mcphase_136(pi/16) a[2], b[1], out[7];
mcphase_137(pi/32) a[2], b[1], out[8];
mcphase_138(pi/64) a[2], b[1], out[9];
mcphase_139(4*pi) a[2], b[0], out[0];
mcphase_140(32*pi) a[1], b[4], out[0];
mcphase_141(2*pi) a[2], b[0], out[1];
mcphase_142(16*pi) a[1], b[4], out[1];
mcphase_143(pi) a[2], b[0], out[2];
mcphase_144(8*pi) a[1], b[4], out[2];
mcphase_145(pi/2) a[2], b[0], out[3];
mcphase_146(4*pi) a[1], b[4], out[3];
mcphase_147(pi/4) a[2], b[0], out[4];
mcphase_148(2*pi) a[1], b[4], out[4];
mcphase_149(pi/8) a[2], b[0], out[5];
mcphase_150(pi) a[1], b[4], out[5];
mcphase_151(pi/16) a[2], b[0], out[6];
mcphase_152(pi/2) a[1], b[4], out[6];
mcphase_153(pi/32) a[2], b[0], out[7];
mcphase_154(pi/4) a[1], b[4], out[7];
mcphase_155(pi/64) a[2], b[0], out[8];
mcphase_156(pi/8) a[1], b[4], out[8];
mcphase_157(pi/128) a[2], b[0], out[9];
mcphase_158(pi/16) a[1], b[4], out[9];
mcphase_159(16*pi) a[1], b[3], out[0];
mcphase_160(8*pi) a[1], b[3], out[1];
mcphase_161(4*pi) a[1], b[3], out[2];
mcphase_162(2*pi) a[1], b[3], out[3];
mcphase_163(pi) a[1], b[3], out[4];
mcphase_164(pi/2) a[1], b[3], out[5];
mcphase_165(pi/4) a[1], b[3], out[6];
mcphase_166(pi/8) a[1], b[3], out[7];
mcphase_167(pi/16) a[1], b[3], out[8];
mcphase_168(pi/32) a[1], b[3], out[9];
mcphase_169(8*pi) a[1], b[2], out[0];
mcphase_170(4*pi) a[1], b[2], out[1];
mcphase_171(2*pi) a[1], b[2], out[2];
mcphase_172(pi) a[1], b[2], out[3];
mcphase_173(pi/2) a[1], b[2], out[4];
mcphase_174(pi/4) a[1], b[2], out[5];
mcphase_175(pi/8) a[1], b[2], out[6];
mcphase_176(pi/16) a[1], b[2], out[7];
mcphase_177(pi/32) a[1], b[2], out[8];
mcphase_178(pi/64) a[1], b[2], out[9];
mcphase_179(4*pi) a[1], b[1], out[0];
mcphase_180(2*pi) a[1], b[1], out[1];
mcphase_181(pi) a[1], b[1], out[2];
mcphase_182(pi/2) a[1], b[1], out[3];
mcphase_183(pi/4) a[1], b[1], out[4];
mcphase_184(pi/8) a[1], b[1], out[5];
mcphase_185(pi/16) a[1], b[1], out[6];
mcphase_186(pi/32) a[1], b[1], out[7];
mcphase_187(pi/64) a[1], b[1], out[8];
mcphase_188(pi/128) a[1], b[1], out[9];
mcphase_189(2*pi) a[1], b[0], out[0];
mcphase_190(16*pi) a[0], b[4], out[0];
mcphase_191(pi) a[1], b[0], out[1];
mcphase_192(8*pi) a[0], b[4], out[1];
mcphase_193(pi/2) a[1], b[0], out[2];
mcphase_194(4*pi) a[0], b[4], out[2];
mcphase_195(pi/4) a[1], b[0], out[3];
mcphase_196(2*pi) a[0], b[4], out[3];
mcphase_197(pi/8) a[1], b[0], out[4];
mcphase_198(pi) a[0], b[4], out[4];
mcphase_199(pi/16) a[1], b[0], out[5];
mcphase_200(pi/2) a[0], b[4], out[5];
mcphase_201(pi/32) a[1], b[0], out[6];
mcphase_202(pi/4) a[0], b[4], out[6];
mcphase_203(pi/64) a[1], b[0], out[7];
mcphase_204(pi/8) a[0], b[4], out[7];
mcphase_205(pi/128) a[1], b[0], out[8];
mcphase_206(pi/16) a[0], b[4], out[8];
mcphase_207(pi/256) a[1], b[0], out[9];
mcphase_208(pi/32) a[0], b[4], out[9];
mcphase_209(8*pi) a[0], b[3], out[0];
mcphase_210(4*pi) a[0], b[3], out[1];
mcphase_211(2*pi) a[0], b[3], out[2];
mcphase_212(pi) a[0], b[3], out[3];
mcphase_213(pi/2) a[0], b[3], out[4];
mcphase_214(pi/4) a[0], b[3], out[5];
mcphase_215(pi/8) a[0], b[3], out[6];
mcphase_216(pi/16) a[0], b[3], out[7];
mcphase_217(pi/32) a[0], b[3], out[8];
mcphase_218(pi/64) a[0], b[3], out[9];
mcphase_219(4*pi) a[0], b[2], out[0];
mcphase_220(2*pi) a[0], b[2], out[1];
mcphase_221(pi) a[0], b[2], out[2];
mcphase_222(pi/2) a[0], b[2], out[3];
mcphase_223(pi/4) a[0], b[2], out[4];
mcphase_224(pi/8) a[0], b[2], out[5];
mcphase_225(pi/16) a[0], b[2], out[6];
mcphase_226(pi/32) a[0], b[2], out[7];
mcphase_227(pi/64) a[0], b[2], out[8];
mcphase_228(pi/128) a[0], b[2], out[9];
mcphase_229(2*pi) a[0], b[1], out[0];
mcphase_230(pi) a[0], b[1], out[1];
mcphase_231(pi/2) a[0], b[1], out[2];
mcphase_232(pi/4) a[0], b[1], out[3];
mcphase_233(pi/8) a[0], b[1], out[4];
mcphase_234(pi/16) a[0], b[1], out[5];
mcphase_235(pi/32) a[0], b[1], out[6];
mcphase_236(pi/64) a[0], b[1], out[7];
mcphase_237(pi/128) a[0], b[1], out[8];
mcphase_238(pi/256) a[0], b[1], out[9];
mcphase_239(pi) a[0], b[0], out[0];
mcphase_240(pi/2) a[0], b[0], out[1];
mcphase_241(pi/4) a[0], b[0], out[2];
mcphase_242(pi/8) a[0], b[0], out[3];
mcphase_243(pi/16) a[0], b[0], out[4];
mcphase_244(pi/32) a[0], b[0], out[5];
mcphase_245(pi/64) a[0], b[0], out[6];
mcphase_246(pi/128) a[0], b[0], out[7];
mcphase_247(pi/256) a[0], b[0], out[8];
mcphase_248(pi/512) a[0], b[0], out[9];
_circuit_456_dg out[0], out[1], out[2], out[3], out[4], out[5], out[6], out[7], out[8], out[9];
barrier a[0], a[1], a[2], a[3], a[4], b[0], b[1], b[2], b[3], b[4], out[0], out[1], out[2], out[3], out[4], out[5], out[6], out[7], out[8], out[9];
meas[0] = measure a[0];
meas[1] = measure a[1];
meas[2] = measure a[2];
meas[3] = measure a[3];
...
meas[8] = measure b[3];
meas[9] = measure b[4];
meas[10] = measure out[0];
meas[11] = measure out[1];
meas[12] = measure out[2];
meas[13] = measure out[3];
meas[14] = measure out[4];
meas[15] = measure out[5];
meas[16] = measure out[6];
meas[17] = measure out[7];
meas[18] = measure out[8];
meas[19] = measure out[9];
