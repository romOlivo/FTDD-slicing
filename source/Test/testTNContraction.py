...
class TestTNContraction(unittest.TestCase):
    ...
    def test_before_tetris_sequential_medium_circuit_close_close(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_before(circuit, is_input_closed=True, is_output_closed=True)
        self.assertEqual(creator.get_medium_circuit_solution_close_close(), tdd.to_array())

    def test_before_tetris_sequential_medium_circuit_close_open(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_before(circuit, is_input_closed=True, is_output_closed=False)
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_close_open(), tdd.to_array()))

    def test_before_tetris_sequential_medium_circuit_open_close(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_before(circuit, is_input_closed=False, is_output_closed=True)
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_open_close(), tdd.to_array()))

    def test_before_tetris_sequential_medium_circuit_open_open(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_before(circuit, is_input_closed=False, is_output_closed=False)
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_open_open(), tdd.to_array()))

    def test_before_tetris_cotengra_medium_circuit_close_close(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_before(circuit, is_input_closed=True, is_output_closed=True, contraction_method='cot')
        self.assertEqual(creator.get_medium_circuit_solution_close_close(), tdd.to_array())

    def test_before_tetris_cotengra_medium_circuit_close_open(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_before(circuit, is_input_closed=True, is_output_closed=False, contraction_method='cot')
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_close_open(), tdd.to_array()))

    def test_before_tetris_cotengra_medium_circuit_open_close(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_before(circuit, is_input_closed=False, is_output_closed=True, contraction_method='cot')
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_open_close(), tdd.to_array()))

    def test_before_tetris_cotengra_medium_circuit_open_open(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_before(circuit, is_input_closed=False, is_output_closed=False, contraction_method='cot')
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_open_open(), tdd.to_array()))

    def test_after_tetris_sequential_medium_circuit_close_close(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_after(circuit, is_input_closed=True, is_output_closed=True)
        self.assertEqual(creator.get_medium_circuit_solution_close_close(), tdd.to_array())

    def test_after_tetris_sequential_medium_circuit_close_open(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_after(circuit, is_input_closed=True, is_output_closed=False)
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_close_open(), tdd.to_array()))

    def test_after_tetris_sequential_medium_circuit_open_close(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_after(circuit, is_input_closed=False, is_output_closed=True)
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_open_close(), tdd.to_array()))

    def test_after_tetris_sequential_medium_circuit_open_open(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_after(circuit, is_input_closed=False, is_output_closed=False)
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_open_open(), tdd.to_array()))

    def test_after_tetris_cotengra_medium_circuit_close_close(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_after(circuit, is_input_closed=True, is_output_closed=True, contraction_method='cot')
        self.assertEqual(creator.get_medium_circuit_solution_close_close(), tdd.to_array())

    def test_after_tetris_cotengra_medium_circuit_close_open(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_after(circuit, is_input_closed=True, is_output_closed=False, contraction_method='cot')
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_close_open(), tdd.to_array()))

    def test_after_tetris_cotengra_medium_circuit_open_close(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_after(circuit, is_input_closed=False, is_output_closed=True, contraction_method='cot')
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_open_close(), tdd.to_array()))

    def test_after_tetris_cotengra_medium_circuit_open_open(self):
        global creator
        circuit = create_medium_circuit()
        tdd = simulate_circuit_after(circuit, is_input_closed=False, is_output_closed=False, contraction_method='cot')
        self.assertTrue(equal_tolerance(creator.get_medium_circuit_solution_open_open(), tdd.to_array()))
